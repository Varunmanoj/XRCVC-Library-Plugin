...
For a list of archived requests, use Member Archives or Admin Archives. Never search request history for a status named archived; archived selection is based on the stored `isArchived` Boolean.
