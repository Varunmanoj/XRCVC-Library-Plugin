...
This distributable package provides **XRCVC Library—X Real-time Communication Verification and Control**. It connects supported AI clients to the XRCVC Library MCP server and includes seven focused skills: public catalog research; member requests, orders, and cart; Admin transactions; Admin/Developer reports; tasks and activity; a library introduction; and public documentation guidance.
